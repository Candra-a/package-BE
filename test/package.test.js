...
describe('Package Controller', () => {
  ...
  describe('GET /package/:id', () => {
    it('should get a package by ID', (done) => {
      chai
        .request(app)
        .get('/package/:id') // Replace :id with a valid package ID
        .end((err, res) => {
          expect(res).to.have.status(200);
          expect(res.body).to.have.property('data');
          done();
  ...
  describe('PUT /package/:id', () => {
    it('should update a package', (done) => {
      chai
        .request(app)
        .put('/package/65311f181f7272b41277d350') // Replace :id with a valid package ID
        .send({
            "transaction_id": "d0090c40-539f-479a-8274-899b9970bddc",
            "customer_name": "PT. AMARA PRIMATIGA",
            "customer_code": "1678593",
  ...
  describe('PATCH /package/:id', () => {
    it('should update a package', (done) => {
      chai
        .request(app)
        .patch('/package/:id') // Replace :id with a valid package ID
        .send({
            "currentLocation": {
                "name": "Hub Jakarta Selatan",
                "code": "JKTS01",
  ...
  describe('GET /package', () => {
    it('should get a list of package', (done) => {
      chai
        .request(app)
        .get('/package')
        .end((err, res) => {
  ...
  describe('DELETE /package/:id', () => {
    it('should delete a package', (done) => {
      chai
        .request(app)
        .delete('/package/:id') // Replace :id with a valid package ID
        .end((err, res) => {
          expect(res).to.have.status(200);
          done();
        });
